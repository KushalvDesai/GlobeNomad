...
const DEV_CSP = [
  ...
  "connect-src 'self' ws: wss: cdn.jsdelivr.net js.sentry-cdn.com browser.sentry-cdn.com *.sentry.io challenges.cloudflare.com https://api.stripe.com https://maps.googleapis.com https://*.js.stripe.com https://js.stripe.com http://localhost:3000 http://localhost:3000/graphql",
...
const nextConfig: NextConfig = {
  // Temporarily disable CSP to fix the "Failed to fetch" issue
  // async headers() {
  //   return [
  //     {
  //       source: "/(.*)",
